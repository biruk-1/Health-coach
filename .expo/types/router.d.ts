...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/ask` | `/ask` | `/(tabs)/favorites` | `/favorites` | `/(tabs)/` | `/(tabs)` | `/(tabs)/.bak` | `/.bak` | `/(tabs)/settings` | `/settings` | `/(tabs)/_layout.tsx.bak` | `/_layout.tsx.bak` | `/coach-onboarding` | `/cosmic-ai-chat` | `/cosmic-ai-subscription` | `/help` | `/hooks/useAppInitialization` | `/hooks/useNavigationGuard` | `/login` | `/onboarding-select` | `/onboarding` | `/psychic-onboarding/background` | `/psychic-onboarding/` | `/psychic-onboarding/languages` | `/psychic-onboarding/profile-photo` | `/psychic-onboarding/specialties` | `/PurchaseScreen` | `/review-request` | `/services/stripe` | `/settings/about` | `/settings/account` | `/settings/add-funds` | `/settings/appearance` | `/settings/contact` | `/settings/help` | `/settings/` | `/settings/legal/guidelines` | `/settings/legal/privacy` | `/settings/legal/terms` | `/settings/notifications` | `/settings/privacy` | `/temp/.bak` | `/temp/.original` | `/user-onboarding` | `/verify-details` | `/verify-psychic` | `/verify-success`;
  // prettier-ignore
