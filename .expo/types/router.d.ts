...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/favorites` | `/favorites` | `/(tabs)/` | `/(tabs)` | `/(tabs)/settings` | `/settings` | `/coach-onboarding` | `/cosmic-ai-chat` | `/cosmic-ai-subscription` | `/help` | `/login` | `/onboarding-select` | `/onboarding` | `/psychic-onboarding/background` | `/psychic-onboarding/` | `/psychic-onboarding/languages` | `/psychic-onboarding/profile-photo` | `/psychic-onboarding/specialties` | `/PurchaseScreen` | `/review-request` | `/services/stripe` | `/settings/about` | `/settings/account` | `/settings/add-funds` | `/settings/appearance` | `/settings/contact` | `/settings/help` | `/settings/` | `/settings/legal/guidelines` | `/settings/legal/privacy` | `/settings/legal/terms` | `/settings/notifications` | `/settings/privacy` | `/user-onboarding` | `/verify-details` | `/verify-psychic` | `/verify-success` | `/coach-verification` | `/register`;
  // prettier-ignore
