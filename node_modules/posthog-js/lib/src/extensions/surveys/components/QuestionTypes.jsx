...
export function MultipleChoiceQuestion(_a) {
    ...
    var handleOpenEndedInputChange = function (value) {
    ...
    return (<div>
            ...
            return (<div className={choiceClass} key={idx}>
                            ...
                            <label htmlFor={"surveyQuestion".concat(displayQuestionIndex, "Choice").concat(idx)} style={{ color: 'black' }}>
                                {isOpenChoice ? (<>
                                        <span>{choice}:</span>
                                        <input type="text" ref={openChoiceInputRef} id={"surveyQuestion".concat(displayQuestionIndex, "Choice").concat(idx, "Open")} name={"question".concat(displayQuestionIndex)} value={openEndedInput} onInput={function (e) { return handleOpenEndedInputChange(e.currentTarget.value); }} onClick={function (e) {
