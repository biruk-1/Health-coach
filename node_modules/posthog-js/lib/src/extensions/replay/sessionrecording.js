...
var logger = createLogger(LOGGER_PREFIX);
...
var SessionRecording = /** @class */ (function () {
    function SessionRecording(instance) {
        ...
        if (this.sessionIdleThresholdMilliseconds >= this.sessionManager.sessionTimeoutMs) {
            logger.warn("session_idle_threshold_ms (".concat(this.sessionIdleThresholdMilliseconds, ") is greater than the session timeout (").concat(this.sessionManager.sessionTimeoutMs, "). Session will never be detected as idle"));
        }
    }
    ...
    Object.defineProperty(SessionRecording.prototype, "masking", {
        get: function () {
            var _a, _b, _c, _d, _e, _f;
            var masking_server_side = this.instance.get_property(SESSION_RECORDING_MASKING);
            var masking_client_side = {
                maskAllInputs: (_a = this.instance.config.session_recording) === null || _a === void 0 ? void 0 : _a.maskAllInputs,
                maskTextSelector: (_b = this.instance.config.session_recording) === null || _b === void 0 ? void 0 : _b.maskTextSelector,
                blockSelector: (_c = this.instance.config.session_recording) === null || _c === void 0 ? void 0 : _c.blockSelector,
            };
    ...
    SessionRecording.prototype._resetSampling = function () {
        var _a;
        (_a = this.instance.persistence) === null || _a === void 0 ? void 0 : _a.unregister(SESSION_RECORDING_IS_SAMPLED);
    };
    SessionRecording.prototype.makeSamplingDecision = function (sessionId) {
        ...
        var shouldSample = makeDecision ? sampleOnProperty(sessionId, currentSampleRate) : storedIsSampled;
        if (makeDecision) {
            if (shouldSample) {
        ...
        (_b = this.instance.persistence) === null || _b === void 0 ? void 0 : _b.register((_a = {},
            _a[SESSION_RECORDING_IS_SAMPLED] = shouldSample,
            _a));
    };
        ...
        if (this.instance.persistence) {
            ...
            var persistResponse = function () {
                ...
                persistence_1.register((_a = {},
                    ...
                    _a[SESSION_RECORDING_MASKING] = (_f = response.sessionRecording) === null || _f === void 0 ? void 0 : _f.masking,
                    ...
                    _a[SESSION_RECORDING_SCRIPT_CONFIG] = (_k = response.sessionRecording) === null || _k === void 0 ? void 0 : _k.scriptConfig,
                    _a));
            };
            persistResponse();
    ...
    SessionRecording.prototype._updateWindowAndSessionIds = function (event) {
        ...
        if (isUserInteraction) {
            ...
            if (this.isIdle) {
                var idleWasUnknown = this.isIdle === 'unknown';
    ...
    SessionRecording.prototype._onScriptLoaded = function () {
        ...
        if (this.masking) {
            sessionRecordingOptions.maskAllInputs = (_b = this.masking.maskAllInputs) !== null && _b !== void 0 ? _b : true;
            sessionRecordingOptions.maskTextSelector = (_c = this.masking.maskTextSelector) !== null && _c !== void 0 ? _c : undefined;
            sessionRecordingOptions.blockSelector = (_d = this.masking.blockSelector) !== null && _d !== void 0 ? _d : undefined;
        }
        ...
        this.mutationRateLimiter =
            (_e = this.mutationRateLimiter) !== null && _e !== void 0 ? _e : new MutationRateLimiter(rrwebRecord, {
        ...
        this.stopRrweb = rrwebRecord(__assign({ emit: function (event) {
    ...
    SessionRecording.prototype._checkUrlTriggerConditions = function () {
        ...
        var wasBlocked = this._urlBlocked;
