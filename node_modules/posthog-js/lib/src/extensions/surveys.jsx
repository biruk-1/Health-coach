    ...
    useEffect(function () {
        ...
        if (((_c = survey.appearance) === null || _c === void 0 ? void 0 : _c.widgetType) === 'selector') {
            ...
            addEventListener(widget, 'click', function (event) {
                ...
                var estimatedMinSurveyHeight = 250;
                ...
                setStyle(function (prev) {
                    var _a;
                    return (__assign(__assign({}, prev), { position: 'fixed', top: showAbove ? 'auto' : buttonRect.bottom + spacing + 'px', left: left + 'px', right: 'auto', bottom: showAbove ? viewportHeight - buttonRect.top + spacing + 'px' : 'auto', boxShadow: '0 4px 12px rgba(0, 0, 0, 0.15)', borderBottom: "1.5px solid ".concat(((_a = survey.appearance) === null || _a === void 0 ? void 0 : _a.borderColor) || '#c9c6c6'), borderRadius: '10px', zIndex: SURVEY_DEFAULT_Z_INDEX }));
                });
